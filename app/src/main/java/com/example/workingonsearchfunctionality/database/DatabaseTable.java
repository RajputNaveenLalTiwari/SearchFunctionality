package com.example.workingonsearchfunctionality.database;
...
public class DatabaseTable
{
    ...
    {
        mDatabaseOpenHelper = new DatabaseOpenHelper(context,DATABASE_NAME,CURSOR_FACTORY,DATABASE_VERSION);
    }
